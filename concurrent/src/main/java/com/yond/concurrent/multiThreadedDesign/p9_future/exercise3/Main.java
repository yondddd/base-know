package com.yond.concurrent.multiThreadedDesign.p9_future.exercise3;
...
public class Main {
    public static void main(String[] args) {
        ...
        saveToFile("static/multiThreadedDesign/google.html", content1);
        saveToFile("static/multiThreadedDesign/baidu.html", content2);
        saveToFile("static/multiThreadedDesign/hyuki.html", content3);
